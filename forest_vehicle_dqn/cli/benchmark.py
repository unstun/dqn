...
def main() -> int:
    ...
    ap.add_argument("--rand-min-dist-m", type=float, default=6.0)
    ap.add_argument("--rand-max-dist-m", type=float, default=0.0)
    ...
    if bool(args.random_train):
        train_cmd += [
            ...
            str(args.rand_min_dist_m),
            "--forest-rand-max-dist-m",
            str(args.rand_max_dist_m),
