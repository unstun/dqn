...
from forest_vehicle_dqn.config_io import parser_defaults
...
def main(argv: list[str] | None = None) -> int:
    ...
    with contextlib.redirect_stdout(io.StringIO()), contextlib.redirect_stderr(io.StringIO()):
        from forest_vehicle_dqn.cli.infer import build_parser as build_infer_parser
        from forest_vehicle_dqn.cli.train import build_parser as build_train_parser
