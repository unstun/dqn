...
## 2) run 路径登记
- train：
  - `run_dir`：`runs/v7p2p9_ablate_expert_smoke/train_20260221_231402`
  - `run_json`：`runs/v7p2p9_ablate_expert_smoke/train_20260221_231402/configs/run.json`
  - `train_meta`：`runs/v7p2p9_ablate_expert_smoke/train_20260221_231402/configs/train_meta_forest_a.json`
  - `train_flow_log`：`runs/v7p2p9_ablate_expert_smoke/train_20260221_231402/train_flow.log`
- infer：
  - `run_dir`：`runs/v7p2p9_ablate_expert_smoke/train_20260221_231402/infer/20260221_232825`
  - `run_json`：`runs/v7p2p9_ablate_expert_smoke/train_20260221_231402/infer/20260221_232825/configs/run.json`
  - `kpi_mean_raw`：`runs/v7p2p9_ablate_expert_smoke/train_20260221_231402/infer/20260221_232825/table2_kpis_mean_raw.csv`
  - `kpi_raw`：`runs/v7p2p9_ablate_expert_smoke/train_20260221_231402/infer/20260221_232825/table2_kpis_raw.csv`

## 3) 关键参数快照
- 复现配置：`configs/repro_20260221_v7p2p9_ablate_expert_smoke.json`
- 相对 `v7p2p8` 单变量改动：
...
- 保持不变的关键参数：
  ...
  - `profile=repro_20260221_v7p2p9_ablate_expert_smoke`
  - `runs=3`
...
## 4) short/long 关键指标
- short：
  - CNN-DDQN：`success_rate=0.667`，`avg_path_length=16.3453`，`path_time_s=26.2750`
