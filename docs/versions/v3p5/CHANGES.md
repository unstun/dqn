...
- `forest_demo_pretrain_steps`: `20000` -> `30000`
- `forest_demo_pretrain_early_stop_sr`: `0.7` -> `0.5`
- `forest_demo_pretrain_early_stop_patience`: `2` -> `1`
...
## 命令覆盖（如有）
- argv: `train.py --profile repro_20260209_forest_a_cnn_ddqn_strict_no_fallback_v3p1_smoke --out repro_20260209_forest_a_cnn_ddqn_strict_no_fallback_v3p5_smoke --episodes 180 --save-ckpt final`
