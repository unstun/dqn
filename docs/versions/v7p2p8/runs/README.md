...
## 2) run 路径登记
- train：
  - `run_dir`：`runs/v7p2p8_bold_dynamic_expert_smoke/train_20260221_225358`
  - `run_json`：`runs/v7p2p8_bold_dynamic_expert_smoke/train_20260221_225358/configs/run.json`
  - `train_meta`：`runs/v7p2p8_bold_dynamic_expert_smoke/train_20260221_225358/configs/train_meta_forest_a.json`
  - `train_flow_log`：`runs/v7p2p8_bold_dynamic_expert_smoke/train_20260221_225358/train_flow.log`
- infer：
  - `run_dir`：`runs/v7p2p8_bold_dynamic_expert_smoke/train_20260221_225358/infer/20260221_230426`
  - `run_json`：`runs/v7p2p8_bold_dynamic_expert_smoke/train_20260221_225358/infer/20260221_230426/configs/run.json`
  - `kpi_mean_raw`：`runs/v7p2p8_bold_dynamic_expert_smoke/train_20260221_225358/infer/20260221_230426/table2_kpis_mean_raw.csv`
  - `kpi_raw`：`runs/v7p2p8_bold_dynamic_expert_smoke/train_20260221_225358/infer/20260221_230426/table2_kpis_raw.csv`

## 3) 关键参数快照
- 复现配置：`configs/repro_20260221_v7p2p8_bold_dynamic_expert_smoke.json`
- 相对 `v7p2p7` 多变量改动：
...
- 保持不变的关键参数：
  ...
  - `profile=repro_20260221_v7p2p8_bold_dynamic_expert_smoke`
  - `runs=3`
...
- long：
  - CNN-DDQN：`success_rate=1.000`，`avg_path_length=57.0453`，`path_time_s=31.5667`
