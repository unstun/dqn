...
- CNN 成功率 short/long： `0.4` / `0.2`
- Hybrid 成功率 short/long： `0.9` / `1.0`
- CNN 规划代价 short/long： `48.911` / `245.915`
- CNN 路径时间(s) short/long： `23.4` / `27.925`
- CNN argmax 不可行动作率 short/long： `0.139` / `0.235`
...
- short: `timeout=6`, `reached=4`
- long: `timeout=7`, `reached=2`, `collision=1`
- 主要瓶颈：超时崩塌，并非纯粹的 不可行动作 问题。
