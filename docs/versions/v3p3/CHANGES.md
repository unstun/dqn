...
## 版本意图（版本级）
- Config: `repro_20260209_forest_a_cnn_ddqn_strict_no_fallback_v3p3.json`
- Config: `repro_20260209_forest_a_cnn_ddqn_strict_no_fallback_v3p3_smoke.json`

## 相对上一版的具体变更
- `episodes`: `1` -> `120`
- `forest_action_grid_power`: `<unset>` -> `2.0`
- `forest_demo_pretrain_steps`: `40000` -> `30000`
...
## 命令覆盖（如有）
- argv: `train.py --profile repro_20260209_forest_a_cnn_ddqn_strict_no_fallback_v3p3_smoke`
