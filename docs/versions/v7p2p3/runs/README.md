...
## 2. run 路径登记
- train：
  - `run_dir`：`runs/v7p2p3_globalcnn_fusion_smoke/train_20260221_174334`
  - `run_json`：`runs/v7p2p3_globalcnn_fusion_smoke/train_20260221_174334/configs/run.json`
  - `train_meta`：`runs/v7p2p3_globalcnn_fusion_smoke/train_20260221_174334/configs/train_meta_forest_a.json`
  - `train_flow_log`：`runs/v7p2p3_globalcnn_fusion_smoke/train_20260221_174334/train_flow.log`
- infer：
  - `run_dir`：`runs/v7p2p3_globalcnn_fusion_smoke/train_20260221_174334/infer/20260221_180256`
  - `run_json`：`runs/v7p2p3_globalcnn_fusion_smoke/train_20260221_174334/infer/20260221_180256/configs/run.json`
  - `kpi_mean_raw`：`runs/v7p2p3_globalcnn_fusion_smoke/train_20260221_174334/infer/20260221_180256/table2_kpis_mean_raw.csv`
  - `kpi_raw`：`runs/v7p2p3_globalcnn_fusion_smoke/train_20260221_174334/infer/20260221_180256/table2_kpis_raw.csv`

## 3. 关键参数快照
- 复现配置：`configs/repro_20260221_v7p2p3_globalcnn_fusion_smoke.json`
- 关键差异参数：
  - `train.cnn_backbone=globalcnn_fusion`
  - `train.cnn_global_width=32`
  - `train.cnn_global_dropout=0.1`
- 推理关键参数（来自 infer `run.json`）：
  - `profile=repro_20260221_v7p2p3_globalcnn_fusion_smoke`
  - `runs=3`
...
## 4. short/long 关键指标
- short：
  - CNN-DDQN：`success_rate=0.333`，`avg_path_length=13.1250`，`path_time_s=8.2000`
  - Hybrid A*-MPC：`success_rate=1.000`，`avg_path_length=17.0342`，`path_time_s=10.2667`
- long：
  - CNN-DDQN：`success_rate=0.667`，`avg_path_length=48.5295`，`path_time_s=30.9000`
