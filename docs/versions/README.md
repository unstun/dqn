...
| `v8p9` | `v8p9` | `docs/versions/v8p9/` | `configs/v8p9.json` | `N/A` | `N/A` / `N/A` | `N/A` / `N/A` | 待 sweep smoke → 待 full gate（C：short/long fixed pairs20，runs=20） |
