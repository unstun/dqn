...
| `v8p11` | `v8p11` | `docs/versions/v8p11/` | `configs/v8p11.json` | `N/A` | `N/A` / `N/A` | `N/A` / `N/A` | 进行中（训练侧强化：待 train+infer smoke → 待 full gate C） |
