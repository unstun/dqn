...
- 归档入口：仓库根目录 `README.md` 的“版本总索引（v1 → v6p5）”。
...
| `v6p4` | `v6p4` | `docs/versions/v6p4/` | `configs/v6p4.json` | `N/A` | `N/A` / `N/A` | `N/A` / `N/A` | 已完成配置升级（待 smoke/full） |
| `v6p5` | `v6p5` | `docs/versions/v6p5/` | `configs/v6p5.json` | `N/A` | `N/A` / `N/A` | `N/A` / `N/A` | 已完成局部高分辨率观测 + CNN BatchNorm 改造与 self-check（待 smoke/full） |
