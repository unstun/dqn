...
## 2) run 路径登记
- train：
  - `run_dir`：`runs/v7p2p7_gradclip_recover_smoke/train_20260221_215452`
  - `run_json`：`runs/v7p2p7_gradclip_recover_smoke/train_20260221_215452/configs/run.json`
  - `train_meta`：`runs/v7p2p7_gradclip_recover_smoke/train_20260221_215452/configs/train_meta_forest_a.json`
  - `train_flow_log`：`runs/v7p2p7_gradclip_recover_smoke/train_20260221_215452/train_flow.log`
- infer：
  - `run_dir`：`runs/v7p2p7_gradclip_recover_smoke/train_20260221_215452/infer/20260221_221008`
  - `run_json`：`runs/v7p2p7_gradclip_recover_smoke/train_20260221_215452/infer/20260221_221008/configs/run.json`
  - `kpi_mean_raw`：`runs/v7p2p7_gradclip_recover_smoke/train_20260221_215452/infer/20260221_221008/table2_kpis_mean_raw.csv`
  - `kpi_raw`：`runs/v7p2p7_gradclip_recover_smoke/train_20260221_215452/infer/20260221_221008/table2_kpis_raw.csv`

## 3) 关键参数快照
- 复现配置：`configs/repro_20260221_v7p2p7_gradclip_recover_smoke.json`
- 相对 `v7p2p6` 单变量改动：
...
- 保持不变的关键参数：
  ...
  - `profile=repro_20260221_v7p2p7_gradclip_recover_smoke`
  - `runs=3`
...
## 4) short/long 关键指标
- short：
  - CNN-DDQN：`success_rate=0.333`，`avg_path_length=24.6699`，`path_time_s=14.0000`
  - Hybrid A*-MPC：`success_rate=1.000`，`avg_path_length=17.0342`，`path_time_s=10.2667`
- long：
  - CNN-DDQN：`success_rate=0.333`，`avg_path_length=61.7273`，`path_time_s=32.2000`
