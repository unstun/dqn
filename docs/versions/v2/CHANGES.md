...
## 版本意图（版本级）
- Config: `repro_20260209_forest_a_cnn_ddqn_strict_no_fallback_v2.json`
- Config: `repro_20260209_forest_a_cnn_ddqn_strict_no_fallback_v2_smoke.json`
...
- `demo_lambda`: `5.0` -> `3.0`
- `demo_margin`: `2.0` -> `1.2`
- `per_eps_demo`: `5.0` -> `3.0`
- `forest_no_fallback`: `False` -> `True`
- `forest_action_shield`: `True` -> `False`
- `forest_rand_fixed_prob`: `0.15` -> `0.1`
...
## 命令覆盖（如有）
- argv: `train.py --profile repro_20260209_forest_a_cnn_ddqn_strict_no_fallback_v2_smoke`
