...
## 版本意图（版本级）
- Config: `repro_20260209_forest_a_cnn_ddqn_strict_no_fallback_v3p2.json`
- Config: `repro_20260209_forest_a_cnn_ddqn_strict_no_fallback_v3p2_smoke.json`

## 相对上一版的具体变更
- `episodes`: `300` -> `1`
- `save_ckpt`: `final` -> `pretrain`
- `eps_decay`: `9000` -> `4500`
- `forest_action_grid_power`: `1.0` -> `<unset>`
...
## 命令覆盖（如有）
- argv: `train.py --profile repro_20260209_forest_a_cnn_ddqn_strict_no_fallback_v3p2_smoke --episodes 1 --out repro_20260209_forest_a_cnn_ddqn_strict_no_fallback_v3p2_smoke_ep1`
