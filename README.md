...
| `v8p16` | `docs/versions/v8p16/` | `configs/v8p16.json` | `runs/v8p16_infer_smoke_long_pairs3/20260224_023542` | `1.000 / 1.000` | `1.00 / 1.00` | smoke 已跑：SR=1.0 但 short/long 路径与时间均落后 baseline（NO-GO） |
