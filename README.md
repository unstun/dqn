...
Current recommended train profile: `v6p2p4`
...
```bash
conda run -n ros2py310 python train.py --profile v6p2p4 --episodes 40 --out v6p2p4_smoke
conda run -n ros2py310 python infer.py --profile v6p2p4 --models v6p2p4_smoke --runs 3 --out v6p2p4_smoke
```
